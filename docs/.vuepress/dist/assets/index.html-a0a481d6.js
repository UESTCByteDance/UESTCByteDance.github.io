...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="四、测试结果" tabindex="-1"><a class="header-anchor" href="#四、测试结果" aria-hidden="true">#</a> 四、测试结果</h2><h3 id="_4-1-功能测试" tabindex="-1"><a class="header-anchor" href="#_4-1-功能测试" aria-hidden="true">#</a> <strong>4.1 功能测试</strong></h3><p>使用Postman软件进行功能测试。同时项目中也包含单元测试，均放在test目录下。</p><h4 id="userservice" tabindex="-1"><a class="header-anchor" href="#userservice" aria-hidden="true">#</a> UserService</h4><h5 id="douyin-user-register-用户注册接口" tabindex="-1"><a class="header-anchor" href="#douyin-user-register-用户注册接口" aria-hidden="true">#</a> /douyin/user/register/ - 用户注册接口</h5><table><thead><tr><th>用例描述</th><th>测试结果</th></tr></thead><tbody><tr><td>正确请求</td><td><img src="`+c+'" alt="img"></td></tr><tr><td>重复用户名</td><td><img src="'+v+'" alt="img"></td></tr><tr><td>用户名过长</td><td><img src="'+u+'" alt="img"></td></tr><tr><td>密码过长</td><td><img src="'+m+'" alt="img"></td></tr></tbody></table><h5 id="douyin-user-login-用户登录接口" tabindex="-1"><a class="header-anchor" href="#douyin-user-login-用户登录接口" aria-hidden="true">#</a> /douyin/user/login/ - 用户登录接口</h5><table><thead><tr><th>用例描述</th><th>测试结果</th></tr></thead><tbody><tr><td>正确请求</td><td><img src="'+b+'" alt="img"></td></tr><tr><td>用户名不存在</td><td><img src="'+h+'" alt="img"></td></tr><tr><td>密码错误</td><td><img src="'+g+'" alt="img"></td></tr></tbody></table><h5 id="douyin-user-用户信息" tabindex="-1"><a class="header-anchor" href="#douyin-user-用户信息" aria-hidden="true">#</a> /douyin/user/ - 用户信息</h5><table><thead><tr><th>用例描述</th><th>测试结果</th></tr></thead><tbody><tr><td>正确请求</td><td><img src="'+p+'" alt="img"></td></tr><tr><td>token错误</td><td><img src="'+f+'" alt="img"></td></tr><tr><td>用户不存在</td><td><img src="'+_+'" alt="img"></td></tr></tbody></table><h4 id="videoservice" tabindex="-1"><a class="header-anchor" href="#videoservice" aria-hidden="true">#</a> VideoService</h4><h5 id="douyin-feed-视频流接口" tabindex="-1"><a class="header-anchor" href="#douyin-feed-视频流接口" aria-hidden="true">#</a> /douyin/feed/ - 视频流接口</h5><table><thead><tr><th>用例描述</th><th>测试结果</th></tr></thead><tbody><tr><td>登录状态正确请求</td><td><img src="'+q+'" alt="img"></td></tr><tr><td>未登录状态正确请求</td><td><img src="'+y+'" alt="img"></td></tr><tr><td>token错误</td><td><img src="'+x+'" alt="img"></td></tr></tbody></table><h5 id="douyin-publish-action-视频投稿" tabindex="-1"><a class="header-anchor" href="#douyin-publish-action-视频投稿" aria-hidden="true">#</a> /douyin/publish/action/ - 视频投稿</h5><table><thead><tr><th>用例描述</th><th>测试结果</th></tr></thead><tbody><tr><td>正确请求</td><td><img src="'+S+'" alt="img"></td></tr><tr><td>token错误</td><td><img src="'+k+'" alt="img"></td></tr></tbody></table><h5 id="douyin-publish-list-发布列表" tabindex="-1"><a class="header-anchor" href="#douyin-publish-list-发布列表" aria-hidden="true">#</a> /douyin/publish/list/ - 发布列表</h5><table><thead><tr><th>用例描述</th><th>测试结果</th></tr></thead><tbody><tr><td>正确请求</td><td><img src="'+R+'" alt="img"></td></tr><tr><td>token错误</td><td><img src="'+G+'" alt="img"></td></tr></tbody></table><h4 id="favoriteservice" tabindex="-1"><a class="header-anchor" href="#favoriteservice" aria-hidden="true">#</a> FavoriteService</h4><h5 id="douyin-favorite-list-喜欢列表" tabindex="-1"><a class="header-anchor" href="#douyin-favorite-list-喜欢列表" aria-hidden="true">#</a> <strong>/douyin/favorite/list/ - 喜欢列表</strong></h5><table><thead><tr><th>用例描述</th><th>测试结果</th></tr></thead><tbody><tr><td>正确请求</td><td><img src="'+w+'" alt="img"></td></tr><tr><td>token错误</td><td><img src="'+P+'" alt="img"></td></tr></tbody></table><p><strong>/douyin/favorite/action/ - 赞操作</strong></p><table><thead><tr><th>用例描述</th><th>测试结果</th></tr></thead><tbody><tr><td>点赞成功</td><td><img src="'+T+'" alt="img"></td></tr><tr><td>重复点赞</td><td><img src="'+I+'" alt="img"></td></tr><tr><td>取消点赞</td><td><img src="'+V+'" alt="img"></td></tr><tr><td>token错误</td><td><img src="'+D+'" alt="img"></td></tr></tbody></table><h4 id="commentservice" tabindex="-1"><a class="header-anchor" href="#commentservice" aria-hidden="true">#</a> CommentService</h4><h5 id="douyin-comment-list-评论列表" tabindex="-1"><a class="header-anchor" href="#douyin-comment-list-评论列表" aria-hidden="true">#</a> douyin/comment/list/ - 评论列表</h5><table><thead><tr><th>用例描述</th><th>测试结果</th></tr></thead><tbody><tr><td>正确请求</td><td><img src="'+F+'" alt="img"></td></tr><tr><td>token错误</td><td><img src="'+H+'" alt="img"></td></tr></tbody></table><h5 id="douyin-comment-action-评论操作" tabindex="-1"><a class="header-anchor" href="#douyin-comment-action-评论操作" aria-hidden="true">#</a> douyin/comment/action/ - 评论操作</h5><table><thead><tr><th>用例描述</th><th>测试结果</th></tr></thead><tbody><tr><td>成功评论</td><td><img src="'+C+'" alt="img"></td></tr><tr><td>删除评论</td><td><img src="'+L+'" alt="img"></td></tr><tr><td>token错误</td><td><img src="'+M+'" alt="img"></td></tr></tbody></table><h4 id="relationservice" tabindex="-1"><a class="header-anchor" href="#relationservice" aria-hidden="true">#</a> RelationService</h4><h5 id="douyin-relation-action-关注操作" tabindex="-1"><a class="header-anchor" href="#douyin-relation-action-关注操作" aria-hidden="true">#</a> /douyin/relation/action/ - 关注操作</h5><table><thead><tr><th>用例描述</th><th>测试结果</th></tr></thead><tbody><tr><td>关注成功</td><td><img src="'+N+'" alt="img"></td></tr><tr><td>取消关注</td><td><img src="'+A+'" alt="img"></td></tr><tr><td>关注自己</td><td><img src="'+E+'" alt="img"></td></tr><tr><td>重复关注</td><td><img src="'+J+'" alt="img"></td></tr><tr><td>token错误</td><td><img src="'+B+'" alt="img"></td></tr></tbody></table><h5 id="douyin-relation-follow-list-关注列表" tabindex="-1"><a class="header-anchor" href="#douyin-relation-follow-list-关注列表" aria-hidden="true">#</a> /douyin/relation/follow/list -关注列表</h5><table><thead><tr><th>用例描述</th><th>测试结果</th></tr></thead><tbody><tr><td>拉取关注用户列表</td><td><img src="'+Q+'" alt="img"></td></tr><tr><td>token错误</td><td><img src="'+O+'" alt="img"></td></tr></tbody></table><h5 id="douyin-relation-friend-list-粉丝列表" tabindex="-1"><a class="header-anchor" href="#douyin-relation-friend-list-粉丝列表" aria-hidden="true">#</a> /douyin/relation/friend/list/ - 粉丝列表</h5><table><thead><tr><th>用例描述</th><th>测试结果</th></tr></thead><tbody><tr><td>拉取粉丝列表</td><td><img src="'+W+'" alt="img"></td></tr><tr><td>token错误</td><td><img src="'+U+'" alt="img"></td></tr></tbody></table><h4 id="messageservice" tabindex="-1"><a class="header-anchor" href="#messageservice" aria-hidden="true">#</a> MessageService</h4><h5 id="douyin-message-chat-聊天接口" tabindex="-1"><a class="header-anchor" href="#douyin-message-chat-聊天接口" aria-hidden="true">#</a> /douyin/message/chat/ - 聊天接口</h5><table><thead><tr><th>用例描述</th><th>测试结果</th></tr></thead><tbody><tr><td>获取消息列表</td><td><img src="'+j+'" alt="img"></td></tr><tr><td>查看自己与自己聊天</td><td><img src="'+K+'" alt="img"></td></tr><tr><td>token错误</td><td><img src="'+z+'" alt="img"></td></tr></tbody></table><h5 id="douyin-message-action-发送消息" tabindex="-1"><a class="header-anchor" href="#douyin-message-action-发送消息" aria-hidden="true">#</a> /douyin/message/action/ - 发送消息</h5><table><thead><tr><th>用例描述</th><th>测试结果</th></tr></thead><tbody><tr><td>成功发送消息</td><td><img src="'+X+'" alt="img"></td></tr><tr><td>token错误</td><td><img src="'+Y+'" alt="img"></td></tr></tbody></table><p>通过所有的功能测试，本次要求实现的所有接口功能均正常。</p><h3 id="_4-2-性能测试" tabindex="-1"><a class="header-anchor" href="#_4-2-性能测试" aria-hidden="true">#</a> <strong>4.2 性能测试</strong></h3><p>使用Apache JMeter软件进行性能测试。本次测试选用了三个热门接口，用户登录，点赞视频，评论视频，分别得出相应的聚合报告和图形结果。</p><ul><li>用户登录</li></ul><p><img src="'+Z+'" alt="img"></p><p><img src="'+$+'" alt="img"></p><ul><li>点赞视频</li></ul><p><img src="'+ee+'" alt="img"></p><p><img src="'+te+'" alt="img"></p><ul><li>评论视频</li></ul><p><img src="'+ie+'" alt="img"></p><p><img src="'+de+'" alt="img"></p><p>通过对热门接口的性能测试，可以确定本款抖音app可同时容纳5000用户以上同时刷短视频。从上面的测试结果可以看出，点赞视频接口性能表现的比较好，这是由于使用了消息队列对用户的点赞进行了异步处理，以达到流量削峰的目的。由于我们考虑到实际场景下点赞的并发是要远远大于评论的，也就是说10万点赞的视频可能评论只有几千条，所以没有给视频评论接口使用消息队列。也可以看到在高并发场景下响应时间差强人意，这也是我们需要优化的地方。</p><h2 id="五、demo-演示视频" tabindex="-1"><a class="header-anchor" href="#五、demo-演示视频" aria-hidden="true">#</a> 五、Demo 演示视频</h2><p>暂时无法在成电飞书文档外展示此内容</p><h2 id="六、项目总结与反思" tabindex="-1"><a class="header-anchor" href="#六、项目总结与反思" aria-hidden="true">#</a> 六、项目总结与反思</h2><h3 id="成果" tabindex="-1"><a class="header-anchor" href="#成果" aria-hidden="true">#</a> 成果</h3><blockquote><p>在项目的实施过程中，我们取得了一些显著的成果：</p></blockquote><ul><li>成功实现了微服务架构，实现了各个功能模块的解耦和独立部署，提高了系统的可维护性和可扩展性。</li><li>构建了一个高性能的服务端应用，通过使用 Golang 和相关技术栈，提供了稳定高效的服务能力。</li><li>引入了降级限流、熔断和负载均衡等机制，提高了系统的稳定性和可靠性。</li><li>应用链路追踪工具，实时监控系统的性能和运行状态，及时发现和解决潜在的问题。</li></ul><h3 id="挑战和问题" tabindex="-1"><a class="header-anchor" href="#挑战和问题" aria-hidden="true">#</a> 挑战和问题</h3><blockquote><p>然而，在项目的实施过程中也遇到了一些挑战和问题：</p></blockquote><ul><li>微服务架构的拆分和通信需要仔细规划和设计，避免出现过度耦合或通信瓶颈的情况。</li><li>对于一些复杂的业务逻辑，需要更加细致地进行性能优化，以确保系统能够承受高并发和大规模的请求。</li><li>监控和追踪工具的配置和管理也需要一定的技术和资源投入。</li><li>高并发场景下部分接口响应时间较长。</li></ul><h3 id="未来改进的方向" tabindex="-1"><a class="header-anchor" href="#未来改进的方向" aria-hidden="true">#</a> 未来改进的方向</h3><ul><li>进一步优化性能：针对性地进行性能优化，例如使用分布式缓存技术减少数据库查询、采用更高效的算法等，以提升系统的响应速度和吞吐量。</li><li>引入雪花算法，在高并发环境下快速生成大量ID并确保唯一性。</li><li>引入自动化测试和持续集成：建立全面的自动化测试和持续集成流程，确保代码质量和稳定性，减少潜在的错误和问题。</li><li>加强安全性：进一步加强系统的安全性，包括加密敏感数据、实施访问控制、增强身份认证与授权等措施，以保护系统和用户数据的安全。</li><li>持续学习和技术更新：跟踪和学习最新的技术趋势，不断提升团队成员的技术能力，以适应快速变化的技术环境。</li><li>用户体验改进：持续收集用户反馈并改进用户界面和功能体验，提升用户满意度和用户黏性。</li><li>容错与故障恢复机制：进一步加强系统的容错能力，引入更多的熔断、降级和故障恢复机制，以提高系统的稳定性和可用性。</li><li>加入Prometheus对服务进行检测和管控，实现对项目更好的管理。</li><li>扩展和水平扩容：考虑引入更多的负载均衡策略和扩展机制，实现系统的水平扩容能力，以适应业务的快速增长和流量的变化。</li></ul><p>通过总结和改进，我们可以进一步提升该项目的质量和性能，为用户提供更好的服务体验，并不断适应和应对市场的变化和挑战。</p><h2 id="七、其他补充资料" tabindex="-1"><a class="header-anchor" href="#七、其他补充资料" aria-hidden="true">#</a> 七、其他补充资料</h2><p>我们的项目从最开始的技术选型到框架转变和版本迭代经历了以下过程。</p><p>一开始，我们组的大部分成员对Golang并不熟悉，都处于学习阶段。经过一两次组会的商量讨论后，我们决定选用beego作为项目的后端框架。我们认为beego框架功能较为强大，且内置ORM框架，相比使用Gin还要结合Gorm，beego的bee工具对整个项目的开发也非常方便。因此，我们决定使用beego，并设定了v1版本的预计交付时间为8月14日，并成功按时完成。</p><p>然而，我们意识到在项目评比中要获得好的成绩，仅仅使用当前的技术栈是不够的。参考往届的获奖作品，他们使用了更多且更高级的技术栈，而我们目前只使用了beego+MySQL+FFmpeg+七牛云，显然没有竞争力。经过两次会议的商讨，我们一致认为，由于时间充裕，我们可以对当前的项目进行迭代，并加入更多的技术栈，例如gRPC、Redis、etcd等。</p><p>于是，我们开始在网上寻找教程和网课，但发现beego结合微服务的实例非常少，比如beego+go-micro+etcd的实例几乎没有。少数找到的教程也不够清晰，于是我们花了近两天的时间进行试错。最终得出的结论是放弃beego+微服务，转而使用Gin+Gorm+微服务。于是，我们的极简版抖音项目正式从1.0版本向2.0版本推进。</p><p>当然，这意味着完全抛弃之前的代码，新的版本几乎相当于从零开始。对于某些人来说，可能会觉得之前的工作都白费了。然而，为了脱颖而出，在项目评比中获得奖项，我们只能转换架构重新开始。我们制定了迭代计划，但不幸的是，有三位组员无法参与接下来的迭代开发，因为时间不允许。这给项目迭代带来了额外的困难。只有时间相对空闲的组员承担了更多的代码任务。</p><p>由于要学习和编写全新的东西，大家无法系统地学习所有内容。因此，我们采取了一种解决方案，由一名队员率先编写一部分代码，并召开会议向其他组员讲解，以便他们能够快速参与迭代开发。例如，在v2版中，我们使用了go-micro、Redis、RabbitMQ、etcd等技术。一名组员可以先编写一两个微服务，并给出Redis、etcd、RabbitMQ的使用示例，其他队员可以仿照这些示例进行开发。这大大提高了开发效率。如果遇到困难，其他组员会通过远程协助以最快的速度解决问题。</p><p>经过近十多天的艰苦奋战，我们的项目v2版如期面世。然而，我们并不满足于此，而是对项目进行持续的优化和更新......</p>',134);function ve(ue,me){const i=n("ExternalLinkIcon");return r(),s("div",null,[re,e("blockquote",null,[se,ae,e("p",null,[le,t("："),e("a",oe,[t("https://github.com/UESTCByteDance/ByteRhythm"),a(i)])])]),ce])}const he=d(ne,[["render",ve],["__file","index.html.vue"]]);export{he as default};
